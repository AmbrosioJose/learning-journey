...
import III_Data_Structures._14_Augmenting_Data_Structures.OrderStatisticTree
import org.junit.jupiter.api.Assertions.*
import org.junit.jupiter.api.BeforeEach
import org.junit.jupiter.api.Nested
import org.junit.jupiter.api.Test

internal class OSRedBlackTreesTest {

    @Test
    fun insert() {
        val rbt = OrderStatisticTree()
        rbt.insert(5)
        rbt.insert(16)
        rbt.insert(7)
    ...
    fun rank() {
        ...
        rbt.insert(16)
        rbt.insert(7)
        assertEquals(3, rbt.rank(rbt.search(16)!!))
    }
    ...
    fun rank2() {
        ...
        rbt.insert(19)
        rbt.insert(8)
        assertEquals(3, rbt.rank(rbt.search(19)!!))
    }
    ...
    fun rank3() {
        ...
        rbt.insert(19)
        rbt.insert(8)
        assertEquals(6, rbt.rank(rbt.search(41)!!))
    }
    ...
    fun rank4() {
        ...
        rbt.insert(19)
        rbt.insert(8)
        assertEquals(1, rbt.rank(rbt.search(8)!!))
    }
    ...
    inner class DeleteSequence{
        private var rbt = OrderStatisticTree()

        @BeforeEach
        fun resetTree(){
            rbt = OrderStatisticTree()
            rbt.insert(41)
            rbt.insert(38)
            rbt.insert(31)
            rbt.insert(12)
